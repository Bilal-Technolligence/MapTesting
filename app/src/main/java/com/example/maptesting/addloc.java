...
public class addloc extends FragmentActivity implements OnMapReadyCallback {
...
//                Intent i = new Intent( addloc.this, ViewParkingSlots.class );
//
//                startActivity( i );
            }
        } );
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    supportMapFragment.getMapAsync(addloc.this);
                }
            }
        });
    }
